...
final class Client
{
    ...
    /**
     * @param string $baseUrl Base URL for the Syrtis API, e.g. https://api.syrtis.ai.
    ...
    /**
     * Performs a GET request on the Syrtis API.
     *
    ...
    /**
     * Performs a POST request on the Syrtis API.
     *
     * @param array<string, mixed> $options Request options accepted by Guzzle.
     */
    ...
    /**
     * Performs a PUT request on the Syrtis API.
     *
     * @param array<string, mixed> $options Request options accepted by Guzzle.
     */
    ...
    /**
     * Performs a PATCH request on the Syrtis API.
     *
     * @param array<string, mixed> $options Request options accepted by Guzzle.
     */
    ...
    /**
     * Performs a DELETE request on the Syrtis API.
     *
     * @param array<string, mixed> $options Request options accepted by Guzzle.
     */
